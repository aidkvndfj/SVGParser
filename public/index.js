...
jQuery(document).ready(function () {
                ...
                for (let i = 0; i < data.length; i++) {
                    if (data[i][0] == "ERROR:INVALID_SVG") {
                        ...
                        if (i == 0) {
                            ...
                            $('#scaleSVGDropDown').append("<option selected>" + data[i][0] + "</option>");
                        } else {
                            $('#SVGDropDown').append("<option>" + data[i][0] + "</option>");
                            $('#shapeSVGDropDown').append("<option>" + data[i][0] + "</option>");
                            $('#scaleSVGDropDown').append("<option>" + data[i][0] + "</option>");
                        }
    ...
    $('#scaleShapeForm').submit(function (data) {
        data.preventDefault();
        alert(`Successfully Scaled by ${$('#scaleFactor').val()}`);
    });
